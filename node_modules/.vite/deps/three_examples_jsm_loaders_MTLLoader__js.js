import { Kt as DefaultLoadingManager, To as SRGBColorSpace, Ur as Loader, Wr as LoaderUtils, _o as RepeatWrapping, di as MeshPhongMaterial, ds as TextureLoader, lt as ColorManagement, st as Color, vn as FileLoader, zs as Vector2 } from "./three.module-BKY27AXr.js";
//#region node_modules/three/examples/jsm/loaders/MTLLoader.js
/**
...
var MaterialCreator = class {
	constructor(baseUrl = "", options = {}) {
		...
		this.side = this.options.side !== void 0 ? this.options.side : 0;
				...
				switch (lprop) {
					...
					case "ks":
						...
						if (this.options && this.options.ignoreZeroRGBs) {
							if (value[0] === 0 && value[1] === 0 && value[2] === 0) save = false;
						}
						break;
					default: break;
				}
	...
	create(materialName) {
		if (this.materials[materialName] === void 0) this.createMaterial_(materialName);
	...
	createMaterial_(materialName) {
		...
		function setMapForType(mapType, value) {
			...
			if (mapType === "map" || mapType === "emissiveMap") map.colorSpace = SRGBColorSpace;
			params[mapType] = map;
		}
		for (const prop in mat) {
